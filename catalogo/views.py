...
def home(request):
    ...
    return render(request, 'home.html', {"Productos_home": Productos_home,"categorias": categorias})
def busqueda_resultado(request):
    ...
    if busqueda:
        ...
        return render(request, 'busqueda_resultado.html', {'productos': page_obj})
def detalles(request,id):
    producto_detalles = get_object_or_404(Producto,id=id)
    return render(request,'Detalles.html',{'producto_detalles':producto_detalles})
